...
class CacheBlockInfo
{
   ...
   public:
      CacheBlockInfo(IntPtr tag = ~0, //~ represents reverse every bit.0000 0000 0000 0000->1111 1111 1111 1111 (-1)
      ...
      bool isValid() const { return (m_tag != ((IntPtr) ~0)); }   //m_tag not equal to ~0 , then is valid.

      IntPtr getTag() const { return m_tag; }
      CacheState::cstate_t getCState() const { return m_cstate; }

      void setTag(IntPtr tag) { m_tag = tag; }   //give the value of tag to m_tag
